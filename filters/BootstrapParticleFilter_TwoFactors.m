%not perfect
function [log_p_y_given_theta, estimated_states, estimated_states2] = BootstrapParticleFilter_TwoFactors(y, rho1, sigma1, rho2, sigma2, beta, N, p_y_given_x)
    
    fprintf('rho1 = %f, sigma1 = %f, rho2 = %f, sigma2 = %f, beta = %f\n', rho1, sigma1, rho2, sigma2, beta);
    T                       = length(y);
    p1                      = zeros(N, T);
    p2                      = zeros(N, T);
    w                       = zeros(N, T);
