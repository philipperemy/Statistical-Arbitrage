function [estimated_states, p_y_given_theta] = Ex2_bootstrap_filter_SIR_ESS(y, rho, sigma, beta, N, steps, nu)
    ...
    p_y_given_x = @(y,sig) tpdf(y./sig, nu)./sig;
    N_thr = round(N/3);
    ...
    for i = 1:steps
        ...
        if(i == 1)
            ...
            w(:,i) = w(:,i-1) .* p_y_given_x(y(i), sigma_y);
        end
