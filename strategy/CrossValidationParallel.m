function [ profits, vols, sharpes, I ] = CrossValidationParallel( pp, Spread, strat_func, nstd_range, wts_range, wsize_range, spread_vol )
    tic;
    ...
    for j = 1:length(I);
        ...
        [pl, balance_cum] = strat_func( pp, Spread, 1, length(Spread.px), boll_conf, spread_vol, 0 );
