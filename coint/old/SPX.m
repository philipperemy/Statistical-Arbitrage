...
daily_risk_free_rate = repmat(daily_percentage, 1, length(pl));
...
plot([(pl_strat_cum + costs_outstanding)' pl_risk_free_cum' pl_spx_cum(1:6100) pl_strat_cum' flat_init_bet_cum]);
