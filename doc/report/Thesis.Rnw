...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \label{bollinger4}
    \end{subfigure}
    \caption{Smple Bollinger bands strategy applied to Walt Disney Co NYSE for the year 2002. Lag is 40 days. $B^+_\theta$ is red, $B^-_\theta$ yellow and $m_\theta$ navy blue.}
...
All the triples exhibit a very high Sharpe ratio on the in-sample period and a lower but still promising Sharpe ratio on the out-sample period. 
...
\# of observations in the training window						& 169       &169      & 169    & 169\\
\# of days in the trading period								    & 336       &336      & 336    & 336\\
