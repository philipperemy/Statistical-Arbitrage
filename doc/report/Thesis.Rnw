...
For each $(\mathcal{I}_i)_{1 \leq i \leq 12}$, the cointegrated triples are formed, the models are calibrated and 20 tradable triples are selected based on the $\mathcal{SR}$ criteria. Then, both strategies are tested on the corresponding out-sample set $\mathcal{O}_i$ with the same models parameters. Table 1 summarizes some figures regarding the calibration step.\\
...
\subsection{Case Study: Period 2008-2009}
...
\subsection{Results with Default Parameters for Bollinger Bands}
...
\hline
\end{tabular}
\caption{Statistics about the parameters estimation $\mathcal{M}_7$}
\label{tab:param_stats_1992_1994}
\end{table}
...
\hline
Jan, 1 1990 - Jan, 1 1992 &  & & & \\
Jan, 1 1992 - Jan, 1 1994 &  0.5627 & 0.5195 & -2.9373 & 3.5681 \\ 
Jan, 1 1994 - Jan, 1 1996 &  0.6751 & 0.6075 & -2.3025 & 4.7169 \\
Jan, 1 1996 - Jan, 1 1998 &  0.4010 & 0.3726 & -3.0290 & 4.1024 \\
Jan, 1 1998 - Jan, 1 2000 &  0.2073 & 0.1991 & -2.5701 & 4.0478 \\
Jan, 1 2000 - Jan, 1 2002 &  0.4488 & 0.4118 & -2.2615 & 3.7445 \\
Jan, 1 2002 - Jan, 1 2004 &  0.5194 & 0.5367 & -3.1040 & 4.2277 \\
Jan, 1 2004 - Jan, 1 2006 &  0.5582 & 0.5827 & -2.4348 & 4.1926 \\
Jan, 1 2006 - Jan, 1 2008 &  0.4027 & 0.3539 & -2.5793 & 4.5596 \\
Jan, 1 2008 - Jan, 1 2010 &  & & & \\
Jan, 1 2010 - Jan, 1 2012 &  & & & \\
Jan, 1 2012 - Jan, 1 2014 &  & & & \\
\hline
...
\hline
\end{tabular}
\caption{Statistics about $\mathcal{SR}_O$-distributions for simple and complex volatility modelling. Triple Trading. Equity Set.}
\end{table}
