...
\hline
Period & \multicolumn{1}{|l|}{\specialcell{Sharpe\\ Ratio}} & \multicolumn{1}{|l|}{\specialcell{Max\\Drawdown}} & \multicolumn{1}{|l|}{\specialcell{Annualized\\Returns}} & \multicolumn{1}{|l|}{\specialcell{Annualized\\ Returns \\SPX}} & \multicolumn{1}{|l|}{\specialcell{Sharpe \\Ratio \\SPX}} \\
\hline
\hline
...
\hline
\end{tabular}
\caption{Statistics about the Bollinger bands strategies on the out-sample sets $\mathcal{O}$}
