...
\end{equation}
Algorithm \ref{bootstrap_filter_algo} presents the bootstrap filter algorithm with a resampling at each step. It is the most common sequential monte carlo and provides good results overall. \\
