classdef StochasticVolatilityModelM < HiddenMarkovModel
    ...
    methods
        ...
        function this = StochasticVolatilityModelM(rho, sigma, beta, steps)
        ...
        function generate(this)
            ...
            for i=1:this.steps
                ...
                y(i)   = this.beta * exp(0.5*x(i)) + exp(0.5*x(i))*randn;
            end
