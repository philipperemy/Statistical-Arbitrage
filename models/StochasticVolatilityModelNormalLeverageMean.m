classdef StochasticVolatilityModelNormalLeverageMean < HiddenMarkovModel
    ...
    methods
        ...
        function this = StochasticVolatilityModelNormalLeverageMean(rho, sigma, beta, steps, cor, mu)
